...
const [transparentBg2, setTransparentBg2] = useState<boolean>(false);
  ...
  async function generateImage1() {
    ...
    try {
      ...
      fd.append("preferPro", String(preferPro1)); // ✅ added
...
fd.append("transparentBg", String(transparentBg1));
  ...
  async function generateImage2() {
    ...
    try {
      ...
      fd.append("preferPro", String(preferPro2)); // ✅ added
...
fd.append("transparentBg", String(transparentBg2));
      ...
      if (useImg1AsInput) {
        if (!img1Blob)
          throw new Error("Generate Image 1 first (or uncheck and upload Image 2 input).");
        inputBlob = img1Blob;
      } else {
      ...
      <div className="mx-auto max-w-5xl px-6 py-10">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <section className="rounded-2xl border border-neutral-800 bg-neutral-900/40 p-5">
            ...
            {/* ✅ Pro toggle (only relevant for Gemini) */}
            <div className="mt-3">
              ...
              {provider1 !== "gemini" && (
                <p className="mt-1 text-xs text-neutral-500">
                  Pro toggle applies to Gemini only.
                </p>
              )}
            </div>
            ...
            <div className="mt-4 grid gap-3">
              <div className="flex flex-wrap gap-3">
                <label className="flex items-center gap-2 text-sm">
                  <input
                    type="radio"
                    checked={skuType === "fresh"}
                    onChange={() => setSkuType("fresh")}
                  />
                  Fresh
                </label>
                <label className="flex items-center gap-2 text-sm">
              ...
              <div className="flex flex-wrap gap-3">
                <label className="flex items-center gap-2 text-sm">
                  <input
                    type="radio"
                    checked={mode1 === "upload"}
                    onChange={() => setMode1("upload")}
                  />
                  Upload
                </label>
                <label className="flex items-center gap-2 text-sm">
